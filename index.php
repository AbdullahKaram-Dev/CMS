            ...
            <div class="carousel-inner">
                ...
                while ($slide = mysqli_fetch_assoc($slide_query)) {
                    ...
                    <div class="item <?php echo($x == 0 ? 'active' : ''); ?>">
                        ...
                        <h3 class="carousel_h3"><a
                                    href="post.php?id=<?= $slide['post_id']; ?>"><?php echo $slide['title']; ?></a></h3>
                ...
                <div class="col-sm-4 col-md-4" style="margin-bottom: 20px">
                    <div class="post">
                        ...
                        <div class="content">
                            <div class="author">
                                بواسطة <a
                                        href="profile.php?user=<?= $data['user_id']; ?>"><b><?= $data['username']; ?></b></a>
                                |
                                بتاريخ
                            ...
                            <hr/>
                            <div class="text-left">
                                <a href="post.php?id=<?= $data['post_id']; ?>" class="btn btn-warning btn-sm">اقرأ
                                    المزيد &larr;</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="bg_tab_topic">
                                        ...
                                        <div class="col-md-9">
                                            <h3 class="col-md-12 text-justify"
                                                ...
                                                <a href="post.php?id=<?= $tab_a['post_id']; ?>"
                                                   class="a_1"><?= strip_tags($tab_a['title']); ?></a>
                                            </h3>
                                ...
                                <?php foreach ($result_b as $tab_b) : ?>
                                    <div class="bg_tab_topic">
                                        ...
                                        <div class="col-md-9">
                                            <h3 class="col-md-12 text-justify"
                                                style="margin-top: 8px;background: #009688;padding: 8px;">
                                                <a href="post.php?id=<?= $tab_b['post_id']; ?>"
                                                   class="a_1"><?= strip_tags($tab_a['title']); ?></a>
                                            </h3>
                                            <p class="col-md-12 text-justify">
                                ...
                                <?php foreach ($result_c as $tab_c) : ?>
                                    <div class="bg_tab_topic">
                                        ...
                                        <div class="col-md-9">
                                            <h3 class="col-md-12 text-justify"
                                                style="margin-top: 8px;background: #009688;padding: 8px;">
                                                <a href="post.php?id=<?= $tab_c['post_id']; ?>"
                                                   class="a_1"><?= strip_tags($tab_a['title']); ?></a>
                                            </h3>
                                            <p class="col-md-12 text-justify">
